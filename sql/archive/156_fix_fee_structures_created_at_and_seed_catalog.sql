-- ============================================================================
-- Fix compatibility for fee_structures + public fee catalog + seed defaults
--
-- الهدف:
-- 1) إصلاح بيئة لا تحتوي على العمود created_at في fee_structures
-- 2) جعل RPC كتالوج الرسوم العامة تعمل بدون خطأ
-- 3) تعبئة الرسوم المفقودة للصفوف من القيم المرجعية الحالية
-- ============================================================================
