-- ============================================================================
-- Forms v3 — financial permission submit RPC
-- ============================================================================

create or replace function public.forms_submit_financial_permission_v3(
  p_form_slug text,
  p_locale text,
  p_visibility text,
...
declare
  ...
  v_visibility text := lower(trim(coalesce(p_visibility, 'finance_admin')));
...
grant execute on function public.forms_submit_financial_permission_v3(text,text,text,text,jsonb,jsonb,uuid,jsonb) to authenticated, anon;
