-- ============================================================================
-- Fix family activation finance sync when student_installments.installment_month is NOT NULL
--
-- المشكلة المكتشفة:
-- عند تفعيل الأسرة بعد 152/153/159/161 ظهر:
--   null value in column "installment_month" of relation "student_installments"
--
-- السبب:
-- بعض البيئات القديمة تجعل installment_month إلزامياً، بينما دالة
-- registration_sync_finance_after_family_activation كانت تتركه null.
--
-- الحل:
-- - اشتقاق installment_month من due_date إن كانت ضمن أشهر السنة الأكاديمية
-- - وإلا استخدام شهر البداية أو 9 كقيمة آمنة
-- ============================================================================
