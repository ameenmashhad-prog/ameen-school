-- ============================================================================
-- Forms v3 — printable student registration packet submit RPC
-- ============================================================================

create or replace function public.forms_submit_student_registration_packet_v3(
  p_form_slug text,
  p_locale text,
  p_visibility text,
...
grant execute on function public.forms_submit_student_registration_packet_v3(text,text,text,text,jsonb,jsonb,uuid,jsonb) to authenticated, anon;
