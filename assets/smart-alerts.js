...
var SmartAlerts = {
  ...
  _buildCSS: function() {
    return "#smartAlertsBar{position:fixed;bottom:20px;left:20px;z-index:99999;max-width:320px;font-family:'Cairo','Segoe UI',Tahoma,sans-serif;direction:rtl}#smartAlertsBar .alert-toggle{background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;padding:12px 16px;border-radius:12px;cursor:pointer;box-shadow:0 8px 24px rgba(239,68,68,.4);display:flex;align-items:center;gap:10px;font-weight:700;user-select:none}#smartAlertsBar .alert-count{background:#fff;color:#dc2626;border-radius:999px;padding:2px 10px;font-size:12px;font-weight:700}#smartAlertsBar .alerts-panel{display:none;background:#fff;border-radius:12px;box-shadow:0 12px 40px rgba(0,0,0,.3);margin-bottom:10px;max-height:70vh;overflow-y:auto;padding:12px;color:#1f2937}#smartAlertsBar.open .alerts-panel{display:block}#smartAlertsBar .alert-item{padding:12px;border-radius:8px;margin-bottom:8px;cursor:pointer;border-right:4px solid}#smartAlertsBar .alert-item:hover{background:#f3f4f6}#smartAlertsBar .alert-item.danger{background:#fee2e2;border-color:#dc2626}#smartAlertsBar .alert-item.warning{background:#fef3c7;border-color:#d97706}#smartAlertsBar .alert-item.info{background:#dbeafe;border-color:#2563eb}#smartAlertsBar .alert-title{font-weight:700;font-size:14px;color:#1f2937;margin-bottom:4px}#smartAlertsBar .alert-msg{font-size:12px;color:#4b5563}#smartAlertsBar .alert-header{display:flex;justify-content:space-between;align-items:center;padding:8px 12px;border-bottom:1px solid #e5e7eb;margin-bottom:8px}#smartAlertsBar .alert-close{background:none;border:none;font-size:20px;cursor:pointer;color:#6b7280}@media(max-width:768px){#smartAlertsBar{bottom:80px;left:10px;right:10px;max-width:none}}";
  },
