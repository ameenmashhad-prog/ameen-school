...
,
    ...
    {key:'academicAnalytics', group:'analyticsAdmin', perm:'academic', color:'indigo', icon:'chart', href:'academic-analytics.html?lite=1', title:{ar:'التحليلات الأكاديمية',fa:'تحلیل‌های آموزشی',en:'Academic Analytics'}, desc:{ar:'تحليلات الأداء، الفجوات، والتوقعات للطلاب',fa:'تحلیل عملکرد، شکاف‌ها و پیش‌بینی دانش‌آموزان',en:'Performance analytics, gaps and forecasts'}},
    {key:'certificates', group:'academic', perm:'certificates', color:'gold', icon:'trophy', href:'certificates-generator.html?lite=1', title:{ar:'مولد الشهادات الذكي',fa:'سازنده گواهینامه هوشمند',en:'Smart Certificate Generator'}, desc:{ar:'تصميم وطباعة شهادات تفوق وحضور مخصصة',fa:'طراحی و چاپ گواهینامه‌های موفقیت و حضور',en:'Design and print custom achievement certificates'}},
    {key:'financeGrowth', group:'finance', perm:'finance', color:'teal', icon:'chart', href:'finance-growth-dashboard.html?lite=1', badge:'NEW', title:{ar:'نمو المؤسسة مالياً',fa:'رشد مالی سازمان',en:'Institution Financial Growth'}, desc:{ar:'دخل، مصروف، التزامات وتوقعات نمو',fa:'درآمد، هزینه، تعهدات و پیش‌بینی رشد',en:'Income, expenses, liabilities and growth forecast'}},
    {key:'financeMonthlyClose', group:'finance', perm:'finance', color:'violet', icon:'calendar', href:'finance-monthly-close.html?lite=1', title:{ar:'الإقفال الشهري',fa:'بستن ماهانه',en:'Monthly Close'}, desc:{ar:'إقفال شمسي، مصادقة، وتدقيق شهري',fa:'بستن شمسی، تأیید و حسابرسی ماهانه',en:'Solar monthly close, approval and audit'}},
    {key:'ownerExecutive', group:'analyticsAdmin', perms:['admin','finance'], color:'gold', icon:'crown', href:'owner-executive-board.html?lite=1', badge:'OWNER', title:{ar:'لوحة المالك التنفيذية',fa:'پنل اجرایی مالک',en:'Owner Executive Board'}, desc:{ar:'رؤية تنفيذية موحدة: دخل، رواتب، فائض، اتجاه 6 أشهر',fa:'دید اجرایی واحد: درآمد، حقوق، مازاد، روند ۶ ماهه',en:'Unified executive view: income, payroll, surplus, 6-month trend'}},
    {key:'teacherPayroll', group:'finance', perm:'finance', color:'emerald', icon:'cash', href:'teacher-payroll-finance.html?lite=1', title:{ar:'رواتب المعلمين اليومية',fa:'حقوق روزانه معلمان',en:'Teacher Daily Payroll'}, desc:{ar:'حساب الأجور حسب الحصص والحسميات',fa:'محاسبه حقوق بر اساس کلاس‌ها و کسورات',en:'Payroll by sessions and deductions'}},
    {key:'teacherPunctuality', group:'people', perm:'hr', color:'rose', icon:'clock', href:'teacher-punctuality-admin.html?lite=1', title:{ar:'انضباط المعلمين والحسميات',fa:'انضباط معلمان و کسورات',en:'Teacher Punctuality & Deductions'}, desc:{ar:'تأخيرات، غياب، وحسميات المعلمين',fa:'تأخیر، غیبت و کسورات معلمان',en:'Teacher delays, absences and deductions'}},
    {key:'teacherCheckin', group:'academic', perm:'schedule', color:'cyan', icon:'calendar', href:'teacher-session-checkin.html?lite=1', title:{ar:'تحضير المعلم للحصص',fa:'حضور معلم برای کلاس‌ها',en:'Teacher Session Check-in'}, desc:{ar:'تسجيل دخول المعلم للحصة وإثبات الحضور',fa:'ثبت ورود معلم به کلاس و اثبات حضور',en:'Teacher session check-in and attendance proof'}},
    {key:'parentMessages', group:'people', perms:['admin','teacher','academic','announcements'], color:'emerald', icon:'phone', href:'parent-messages.html?lite=1', title:{ar:'تواصل أولياء الأمور',fa:'ارتباط با والدین',en:'Parent Messaging'}, desc:{ar:'واتساب، رسائل، وتنبيهات أولياء الأمور',fa:'واتساپ، پیام‌ها و اطلاعیه والدین',en:'WhatsApp and parent notifications'}},
    {key:'tasks', group:'analyticsAdmin', perm:'tasks', color:'violet', icon:'settings', href:'tasks-management.html?lite=1', title:{ar:'إدارة المهام',fa:'مدیریت وظایف',en:'Task Management'}, desc:{ar:'مهام، تكليفات ومتابعة التنفيذ',fa:'وظایف، تکالیف و پیگیری اجرا',en:'Tasks, assignments and execution tracking'}},
    {key:'importStudents', group:'people', perm:'registrations', color:'gold', icon:'forms', href:'import-students.html?lite=1', title:{ar:'استيراد الطلاب من Excel',fa:'وارد کردن دانش‌آموزان از اکسل',en:'Import Students from Excel'}, desc:{ar:'رفع ملفات Google Forms وتسجيل جماعي',fa:'بارگذاری فایل‌های گوگل فرم و ثبت گروهی',en:'Upload Google Forms and bulk registration'}},
    {key:'parentPortal', group:'main', perm:'parent', color:'cyan', icon:'people', href:'parent.html?lite=1', title:{ar:'بوابة ولي الأمر (مباشر)',fa:'پورتال والدین (مستقیم)',en:'Parent Portal (Direct)'}, desc:{ar:'وصول مباشر لبوابة ولي الأمر للمراجعة',fa:'دسترسی مستقیم به پورتال والدین',en:'Direct parent portal access for review'}},
    {key:'studentPortalDirect', group:'main', perm:'student', color:'indigo', icon:'student', href:'student.html?lite=1', title:{ar:'بوابة الطالب (مباشر)',fa:'پورتال دانش‌آموز (مستقیم)',en:'Student Portal Direct'}, desc:{ar:'وصول مباشر لبوابة الطالب',fa:'دسترسی مستقیم پورتال دانش‌آموز',en:'Direct student portal'}},
    {key:'familyReg', group:'people', perm:'registrations', color:'emerald', icon:'forms', href:'family-registration.html?lite=1', badge:'PUBLIC', title:{ar:'تسجيل عائلة جديد (عام)',fa:'ثبت خانواده جدید (عمومی)',en:'New Family Registration (Public)'}, desc:{ar:'صفحة التسجيل العامة لولي الأمر والطلاب',fa:'صفحه ثبت‌نام عمومی والدین و دانش‌آموزان',en:'Public registration for parents and students'}},
    {key:'teacherRegPublic', group:'people', perm:'registrations', color:'teal', icon:'teacher', href:'teacher-registration.html?lite=1', badge:'PUBLIC', title:{ar:'تسجيل معلم (عام)',fa:'ثبت معلم (عمومی)',en:'Teacher Registration (Public)'}, desc:{ar:'صفحة التسجيل العامة للمعلمين',fa:'صفحه ثبت‌نام عمومی معلمان',en:'Public teacher registration page'}},
    {key:'clearSession', group:'analyticsAdmin', perm:'system', color:'slate', icon:'settings', href:'clear-session.html?lite=1', title:{ar:'مسح الجلسة وإعادة الدخول',fa:'پاکسازی نشست و ورود مجدد',en:'Clear Session'}, desc:{ar:'أداة تطوير لمسح localStorage وحل مشاكل الجلسات',fa:'ابزار توسعه برای پاکسازی و حل مشکلات نشست',en:'Dev tool to clear localStorage and fix session issues'}},
    {key:'deploymentCheck', group:'analyticsAdmin', perm:'system', color:'emerald', icon:'check', href:'deployment-check.html?lite=1', title:{ar:'فحص النشر والجاهزية',fa:'بررسی انتشار و آمادگی',en:'Deployment Check'}, desc:{ar:'فحص روابط، أصول، وإعدادات النشر',fa:'بررسی لینک‌ها، دارایی‌ها و تنظیمات انتشار',en:'Check links, assets and deployment config'}},
