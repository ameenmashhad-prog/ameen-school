...
var ROLE_SECTIONS = {
  ...
  teacher: ['overview','students','academic','attendance','schedule','tasks','certificates'],
  staff: ['overview','attendance','tasks','certificates'],
  hr: ['overview','attendance','tasks','certificates'],
